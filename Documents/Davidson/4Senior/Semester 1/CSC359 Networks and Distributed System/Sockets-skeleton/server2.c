...
// Second server: IPv6-only version
...
int main(int argc, char **argv) {
	...
	result = bind(listen_socket, (struct sockaddr *) &address_socket, sizeof(struct sockaddr_in6));
	...
	int client_socket;
	struct sockaddr_in6 client_socket_address;
	socklen_t client_socket_size;

	client_socket_size = sizeof(struct sockaddr_in6);
